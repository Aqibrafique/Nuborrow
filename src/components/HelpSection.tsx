...
function HelpSection() {
  return (
    <>
      {/* main div */}
      <div className="w-full  border bg-[#FAF*FF]  flex flex-row  items-center space-x-14 p-10">
        {/* left div */}
        <div className="border-black border w-full  rounded-lg "></div>
        {/* right div */}
        <div className="border-black border w-full  flex flex-col space-y-4">
          {/* flex col 1 */}
