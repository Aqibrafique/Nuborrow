          ...
          <div className="flex flex-col-reverse lg:flex-row w-full   gap-8 p-2">
            ...
            <div className="flex flex-col w-full h-auto  space-y-4">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <p className="font-sans font-bold text-base">+1 888 372 5588</p>
                </div>
                {/* icon2 */}
                <div className="flex flex-row items-center">
                    <img className="w-10 h-10" src={Footer2} alt="error"/>
                    <p className="font-sans font-bold text-base">hello@nuborrow.com</p>
                </div>
                {/* icon3 */}
                <div className="flex flex-row items-center">
                    <img className="w-10 h-10" src={Footer3} alt="error"/>
                    <p className="font-sans font-bold text-base">Nuborrow Head Office 9135 Keele St. Unit B1 Vaughan, On L4K 1J0</p>
                </div>
                {/* icon4 */}
                <div className="flex flex-row items-center">
                    <img className="w-10 h-10" src={Footer4} alt="error"/>
                    <p className="font-sans font-bold text-base">FSRA Lic # 13115</p>
                </div>
            </div>
          </div>
        </div>
