...
function Cards4({setvalue, value}:all) {
  ...
  return (
    ...
    <img className="w-16 h-16 xl:mt-4 xl:ml-4  ml-5 pt-5 xl:pt-0" src={Back} alt="back error" onClick={Goback} />
    ...
    <div>
        <form className='flex flex-col w-12/12 gap-4 justify-center items-center'>
            <input className='border border-[#EDF3F3] bg-gray-50 rounded-full w-10/12 h-14 p-5 font-semibold' type='text' placeholder='Your name' />
            <input className='border border-[#EDF3F3] bg-gray-50 rounded-full w-10/12 h-14 p-5 font-semibold' type='text' placeholder='Your phone' />
            <input className='border border-[#EDF3F3] bg-gray-50 rounded-full w-10/12 h-14 p-5 font-semibold' type='text' placeholder='Your email' />
            <input className='border border-[#EDF3F3] bg-gray-50 rounded-full w-10/12 h-14 p-5 font-semibold' type='text' placeholder='your address' />
        </form>
    </div>
